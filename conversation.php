                    ...
                    <div>
                        <div class="d-flex flex-column">
                            ...
                            <div class="mt-3">
                                ...
                                <div></div>
                                <span data-toggle="tooltip" data-placement="top" title="Successfull donate/loan made by this user"> <i class="fas fa-arrow-circle-up" style="color:#1cc88a"></i> <strong> <?php echo $user_row["giveCount"]; ?> </strong> </span>
